...
import com.uc2control.databinding.FragmentEspcameraBinding;
import com.uc2control.viewmodels.MainViewModel;

public class EspCameraFragment extends Fragment {
    private MainViewModel modelView;
    private FragmentEspcameraBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        modelView = new ViewModelProvider(getActivity()).get(MainViewModel.class);
        binding =  DataBindingUtil.inflate(inflater, R.layout.fragment_espcamera, container, false);
        binding.setEspcamera(modelView.getEspCameraModel());
